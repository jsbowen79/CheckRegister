...
export function findCategoryNode(currentNode: CategoryNode, target: CategoryNames): CategoryNode | undefined  {
...
export function listCategories(node: CategoryNode, categoriesList: string[]): string[] {
